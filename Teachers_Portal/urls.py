...
urlpatterns = [
	...
	path('<str:Classname>/getstudentsubjecttotals/',getstudentsubjecttotals_view , name='getstudentsubjecttotals'),   
	path('<str:Classname>/publishstudentresult/',publishstudentresult_view , name='publishstudentresult'),   
	...
	path('<str:studentsubject>/<str:Classname>/updatestudentresults',update_student_result_view , name='updatestudentresults'),   
	path('<str:studentsubject>/<str:Classname>/submitallstudentresult',submitallstudentresult_view , name='submitallstudentresult'),   
]